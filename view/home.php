...
?>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="small">Persona logueada: <?php echo $_SESSION['nombre_completo']; ?></div>
                    </div>
                </nav>
            </div>
            <!-- CONTENIDO -->
    ...
    echo 'No has iniciado session <br>
    <button class="btn btn-primary"><a href="login.php"">Iniciar Sesion</a></button>';
}
?>